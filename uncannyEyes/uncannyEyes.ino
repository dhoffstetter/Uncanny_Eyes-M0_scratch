...
//VARIABLES 
//int pirPin = 4;                // input pin for PIR sensor
//int ledPin = 13;                // pin for the built-in LED

// YX5300 MP3 player 
#include "SerialMP3Player.h"

#define TX 6  //  Connect to RX of the MP3 board - sends commands
#define RX 5  // (Optional) Connect to TX of the MP3 Player module 
...
//int PropWait = 0;               // Pause before after motion is detected before scream.  Time in seconds.
//int ResetTime = 10;             // Time until next trigger.  Time in seconds.
...
//Give the PIR sensor some time to calibrate
  Serial.print("Calibrating sensor");  
    ...
    delay(50); 
    */
  // End of Stuff from Scream Box Setup
}
